...
const projectData = {
  ...
  projectIntro: {
    image: "win_white.jpg",
    description:
      "Skonfigurowanie zasad grupowych (GPO) w Active Directory oraz dodanie wirtualnego komputera do istniejącej domeny to zadanie mające na celu centralne zarządzanie ustawieniami użytkowników i komputerów w sieci.",
